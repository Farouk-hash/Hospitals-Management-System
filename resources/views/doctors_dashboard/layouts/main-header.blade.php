									...
									<a href="#" class="d-flex nav-item nav-link pl-0 country-flag1" data-toggle="dropdown" aria-expanded="false"> 
										<span class="avatar country-Flag mr-0 align-self-center bg-transparent">
											@php
												...
												$currentFlag = $currentLocale.'_flag.jpg';
												$currentLanguage = LaravelLocalization::getSupportedLocales()[$currentLocale]['native'] ?? 'English';
											@endphp
											<img src="{{URL::asset('dashboard/img/flags/' . $currentFlag)}}" alt="img">
										</span> 
										<div class="my-auto"> 
											<strong class="mr-2 ml-2 my-auto">{{ $currentLanguage }}</strong> 
										</div> 
									</a> 
						...
						<div class="nav nav-item  navbar-nav-right ml-auto">
									...
									<div class="main-message-list chat-scroll">
										<a href="#" class="p-3 d-flex border-bottom">
											...
											<div class="wd-90p">
												<div class="d-flex">
													<h5 class="mb-1 name">
														{{Auth::user()->name ?? Auth::user()->translations->first()->name}}
								...
								<div class="dropdown-menu">
									<div class="menu-header-content bg-primary text-right">
										...
										<p class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 ">
											You have <span id="notificationCount">{{ App\Models\Events\Notifications::unread('doctor')->count() }}</span> Notifications

										</p>
									</div>
									<div class="main-notification-list Notification-scroll">
										{{-- Notifications Here --}}
										@foreach (App\Models\Events\Notifications::unread('doctor')->get() as $notification )
							...
							<div class="dropdown main-profile-menu nav nav-item nav-link">
								<a class="profile-user d-flex" href="">
									<img alt="" 
									src="{{ asset('dashboard/img/Doctors/' . Auth::user()->image->url) }}">
								</a>
								<div class="dropdown-menu">
