<!-- Modal -->
<div class="modal fade" id="addray{{$invoice->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('doctors_dashboard.diagnostic_ray.store') }}" method="post" autocomplete="off" enctype="multipart/form-data">
                @csrf
