<!-- Modal -->
<div class="modal fade" id="addreview{{$invoice->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('doctors_dashboard.diagnostic_review.store') }}" method="post" autocomplete="off" enctype="multipart/form-data">
                @csrf
