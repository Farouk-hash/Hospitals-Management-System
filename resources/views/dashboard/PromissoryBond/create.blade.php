...
@section('title')
    {{ __('dashboard/finance_trans.add_promissory_bound') }}
@stop
@endsection
...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('dashboard.finance_promissory.store') }}" method="post" autocomplete="off">
                        @csrf
                        ...
                        <div class="pd-30 pd-sm-40 bg-gray-200">
                            ...
                            <div class="row row-xs align-items-center mg-b-20">
                                ...
                                <div class="col-md-11">
                                    <input type="number" step="0.01" name="debit" class="form-control @error('debit') is-invalid @enderror" value="{{ old('debit') }}">
                                    @error('debit')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
